 ...
 * on 2013-05-09 at 11:24:28 UTC 
 * Modify at your own risk.
 */

package com.google.api.services.no.ntnu.emergencyreflect.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserendpointRequest<com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.CollectionResponseUser.class);
    }
  ...
  public class RemoveUser extends UserendpointRequest<com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User> {
    ...
    protected RemoveUser(java.lang.Long id) {
      super(Userendpoint.this, "DELETE", REST_PATH, null, com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.google.api.services.no.ntnu.emergencyreflect.userendpoint.model.User.class);
    }
